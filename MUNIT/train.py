...
if __name__ == "__main__":
    ...
    parser.add_argument('--pre_train', type = bool, default = True, help = 'if train from scratch')
    ...
    parser.add_argument('--load_name', type = str, default = 'WGAN_MUNIT_iter500000_bs1', help = 'load the pre-trained model with certain epoch')
    # GPU parameters
    ...
    parser.add_argument('--lambda_id', type = float, default = 10, help = 'coefficient for ID Loss')
    parser.add_argument('--lambda_gan', type = float, default = 1, help = 'coefficient for gan Loss')
    parser.add_argument('--lambda_content', type = float, default = 1, help = 'coefficient for content Loss')
    parser.add_argument('--lambda_style', type = float, default = 1, help = 'coefficient for style Loss')
    parser.add_argument('--lambda_cycle', type = float, default = 0, help = 'coefficient for cycle Loss')
    ...
    parser.add_argument('--style_dim', type = int, default = 8, help = 'the channels of latent style code')
