...
if __name__ == "__main__":
    ...
    parser.add_argument('--start_decrease_epoch', type = int, default = 100, help = 'lr decrease at certain epoch')
    parser.add_argument('--lr_decrease_divide', type = int, default = 100, help = 'lr decrease divide')
    parser.add_argument('--num_workers', type = int, default = 4, help = 'number of cpu threads to use during batch generation')
    parser.add_argument('--lambda_recon', type = float, default = 10, help = 'coefficient for image reconstruction Loss')
    parser.add_argument('--lambda_gan', type = float, default = 1, help = 'coefficient for GAN Loss')
    parser.add_argument('--lambda_kl', type = float, default = 0.01, help = 'coefficient for KL div Loss')
    parser.add_argument('--lambda_z', type = float, default = 0.5, help = 'coefficient for z reconstruction Loss')
    ...
    parser.add_argument('--z_dim', type = int, default = 8, help = 'latent code dimension')
