...
if __name__ == "__main__":
    ...
    parser.add_argument('--lambda_id', type = float, default = 10, help = 'coefficient for ID recon Loss')
    parser.add_argument('--lambda_gan', type = float, default = 1, help = 'coefficient for gan Loss')
    parser.add_argument('--lambda_content', type = float, default = 1, help = 'coefficient for content recon Loss')
    parser.add_argument('--lambda_style', type = float, default = 1, help = 'coefficient for style recon Loss')
